...
class SortMethods {
	...
	public static void quickSortInternal(int arr[], int begin, int end) {
		if (begin < end) {
			int partitionIndex = partition(arr, begin, end);

			quickSortInternal(arr, begin, partitionIndex - 1);
			quickSortInternal(arr, partitionIndex + 1, end);
		}
	}
